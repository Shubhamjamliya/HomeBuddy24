    ...
    <div ref={containerRef} className="min-h-screen bg-gray-50 pb-10">
      ...
      <header className="bg-white/80 backdrop-blur-md shadow-sm sticky top-0 z-30 border-b border-gray-100">
        <div className="px-4 py-4 flex items-center gap-3">
          ...
          <span className="text-xl font-bold" style={homsterTextGradient}>About HomeBuddy24</span>
        </div>
      </header>
      ...
      <main className="px-5 py-6 space-y-8">
        ...
        <div className="animate-item text-center">
          ...
          <h1 className="text-3xl font-extrabold text-gray-900 mb-2">
            Welcome to <span style={homsterTextGradient}>HomeBuddy24</span>
          </h1>
        ...
        <div className="animate-item">
          <div className="bg-gradient-to-br from-[#347989]/5 to-[#BB5F36]/5 rounded-2xl p-6 border border-[#347989]/10 relative overflow-hidden">
            ...
            <p className="text-sm text-gray-600 leading-relaxed relative z-10">
              HomeBuddy24 is dedicated to revolutionizing how you experience home services. We connect you with top-tier professionals to deliver safe, reliable, and high-quality services right at your doorstep. We believe in making life simpler, one service at a time.
            </p>
          </div>
        </div>
        ...
        {/* Why Choose Us Grid */}
        <div className="animate-item">
          <h3 className="text-lg font-bold text-gray-800 mb-4 px-1">Why Choose HomeBuddy24?</h3>
        ...
        <div className="animate-item text-center pt-4 border-t border-gray-200">
          ...
          <span className="text-sm font-bold tracking-wide" style={homsterTextGradient}>HomeBuddy24 Team</span>
