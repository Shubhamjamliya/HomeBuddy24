        ...
        {currentStep === 'searching' && (
          <div className="text-center py-12 px-6">
            <div className="relative mb-8">
              <div className="animate-spin rounded-full h-20 w-20 border-4 border-gray-100 mx-auto" style={{ borderTopColor: themeColors.button }}></div>
              <div
                className="absolute inset-0 rounded-full border-4 border-transparent animate-spin mx-auto"
                style={{ animationDirection: 'reverse', animationDuration: '1.5s', borderTopColor: themeColors.brand.yellow }}
              ></div>
            </div>
            ...
            <div className="flex justify-center items-center gap-3 mb-6">
              <div className="flex gap-2">
                <div className="w-3 h-3 rounded-full animate-bounce" style={{ backgroundColor: themeColors.button }}></div>
                <div className="w-3 h-3 rounded-full animate-bounce" style={{ backgroundColor: themeColors.button, animationDelay: '0.1s' }}></div>
                <div className="w-3 h-3 rounded-full animate-bounce" style={{ backgroundColor: themeColors.button, animationDelay: '0.2s' }}></div>
              </div>
            </div>
