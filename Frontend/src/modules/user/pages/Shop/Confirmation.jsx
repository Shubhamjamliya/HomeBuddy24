  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] pb-10">
      ...
      <main className="max-w-md mx-auto px-6 pt-16 flex flex-col items-center">
        ...
        {/* Action Buttons */}
        <div className="w-full space-y-4">
          <button className="w-full py-4 bg-blue-500 text-white rounded-2xl font-black text-[16px] shadow-2xl shadow-blue-200 active:scale-95 transition-all flex items-center justify-center gap-2">
            <FiEye className="w-5 h-5" />
            View Order Details
          </button>

          <button className="w-full py-4 bg-white text-gray-700 rounded-2xl font-black text-[15px] border border-gray-200 flex items-center justify-center gap-2 active:scale-95 transition-all">
